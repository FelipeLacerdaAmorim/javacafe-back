...
public class PitadaDeHortela extends BebidaDecorator {
    private BigDecimal precoAdicional;

    public PitadaDeHortela(Bebida bebida, BigDecimal precoAdicional) {
        super(bebida);
    ...
    public String getDescricao() {
        return bebida.getDescricao() + ", pitada de hortelã";
    }
} 